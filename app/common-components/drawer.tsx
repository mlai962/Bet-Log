 ...
 */
const Drawer = ({ trigger, triggerSize, width, children, inline }: DrawerProps) => {
  ...
  return (
    <>
      ...
      {!isOpen && (
        <button
          onClick={openDrawer}
          className={`${inline ? "" : "fixed bottom-4 right-4 z-50 "}${triggerSize} shadow-black shadow-lg cursor-pointer focus:outline-none`}
